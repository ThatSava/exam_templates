...
\begin{center}
    ...
    \textbf{\naslovFormulara \\ Одсек за софтверско инжењерство}
\end{center}
}
...
\textbf{Напомене.} 
Израда одабране опције траjе \ifthenelse{\boolean{ispit}}{180}{120} минута. Није дозвољено
...
калкулатора.
\ifthenelse{\boolean{ispit}}{Градиво jе подељено по колоквиjумима. Сваки колоквиjум састављен jе из два
